                ...
                <?php endif; ?>
                  ...
                  <form class="user" method="post" action="<?php echo e(url('/login')); ?>">
                    ...
                    <div class="form-group">
                      <!--<input type="email" class="form-control form-control-user" name="username" aria-describedby="emailHelp" placeholder="Username Or NIP">-->
                      <input type="text" class="form-control form-control-user" name="username" placeholder="ID Employee">
                    </div>
                    <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\syspark\resources\views/login.blade.php ENDPATH**/ ?>